...
<img src="Questions/image/AdvancedIPScanner.jpg" />  
...
> Encrypt data with Password and only be decoded with cryptoforge by giving password
 <img src="Questions/image/Cryptoforge.jpg" />   
...
* File → Open → Encrypt/Decrypt → Symmetric (Modern) → RC2 → KEY 05 → Decrypt
   ...
   <img src="Questions/image/Crytool.jpg" />   
...
<img src="Questions/image/covertCapture.jpg" /> 
